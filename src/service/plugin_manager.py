...
from src.plugins.trigger.cron_trigger import CronTriggerPlugin
from src.plugins.trigger.feishu_approval import FeishuApprovalTrigger
...
class PluginManager:
    ...
    def register_all(self) -> None:
        ...
        if "feishu_approval" not in self._triggers:
            self.register_trigger(FeishuApprovalTrigger())
        if "cron" not in self._triggers:
            self.register_trigger(CronTriggerPlugin())
